...
describe 'User tea subscriptions search request' do
  describe 'happy path' do
    before :each do
      ...
      @tea_1 = create(:tea, temperature: 195, brew_time: 7)
      @tea_2 = create(:tea, temperature: 202, brew_time: 4)
      @tea_3 = create(:tea, temperature: 190, brew_time: 5)
      @tea_4 = create(:tea, temperature: 175, brew_time: 10)
      @tea_5 = create(:tea, temperature: 212, brew_time: 6, title: "AA Tea")
